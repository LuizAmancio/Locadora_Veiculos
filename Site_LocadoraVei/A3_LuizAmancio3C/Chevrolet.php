    ...
    <section id="agendar" style="background-color: #FAFAD2">
        ...
        <form method="POST" action="Confirma.php" style="text-align: center;">
            ...
            <section id="Cliente">
                ...
                <div class="campo">
                    <label>CPF</label>
                    <input type="number" name="cpf" required maxlength="11" minlength="11">
                </div>
                
               <div class="campo">
                    <label>TELEFONE</label>
                     <input type="number" name="telefone" required maxlength="11" minlength="11">
                </div>
            </section>
           ...
           <section id="Marca">
            ...
            <section id="Modelo"> 
                ...
                <select name="cd_Modelo"required>
                    <option required selected disabled value="">SELECIONE</option>
                    <option value=21>1 - Onix</option>
                    <option value=22>2 - Prisma</option>
                    <option value=23>3 - S10</option>
