...
<body style="background-color: #8181F7">
    ...
    <section id="modelos">
        <div class = "container-fluid modelos text-center margin">
    ...
    <section id="agendar" style="background-color: #F0F8FF">
        <div  class = "container-fluid agendar text-center margin">
        ...
        <form method="POST" action="Confirma.php" style="text-align: center;">
            ...
            <section id="Cliente">
                ...
                <div class="campo">
                    <label>CPF</label>
                    <input type="number" name="cpf" required maxlength="11" required>
                </div>
                
               <div class="campo">
                    <label>TELEFONE</label>
                     <input type="number" name="telefone" required maxlength="11" required>
                </div>
            </section>
           ...
           <section id="Marca">
            ...
            <section id="Modelo"> 
                ...
                <select name="cd_Modelo" required>
                    <option required selected disabled value="">SELECIONE</option>
                    <option value=11>1 - Ka</option>
                    <option value=12>2 - EcoSport</option>
                    <option value=13>3 - New Fiesta</option>
            ...
            <section id="Locacao">
                <div class="campo">
                    Data de locação: <input type="date" name="dtLocacao" required>
                    &nbsp&nbsp Data de devoluçao: <input type="date" name="dtdevolucao" required>
